    ...
    KuCity.prototype = {
        ...
        creatItem: function() {
            if(this.isContainerExit) return;
             var template = '<div class="kucity"><div class="topside"><div class="toback"><a href="javascript:;"><i class="ico-back"></i></a></div><div class="pagetitle"><b>选择国家和地区</b></div></div><div class="citybox"><ul class="kucity_nav"><li class="active"><a href="#hot">HOT</a></li><li><a href="#A">A</a></li><li><a href="#B">B</a></li><li><a href="#C">C</a></li><li><a href="#D">D</a></li><li><a href="#E">E</a></li><li><a href="#F">F</a></li><li><a href="#G">G</a></li><li><a href="#H">H</a></li><li><a href="#J">J</li><li><a href="#K">K</a></li><li><a href="#L">L</a></li><li><a href="#M">M</a></li><li><a href="#N">N</a></li><li><a href="#P">P</a></li><li><a href="#R">R</a></li><li><a href="#B">S</a></li><li><a href="#T">T</a></li><li><a href="#W">W</a></li><li><a href="#X">X</a></li><li><a href="#Y">Y</a></li><li><a href="#Z">Z</a></li></ul><div class="kucity_body"></div></div><ul class="result"></ul></div>';
        ...
        citySelect: function() {
            var self = this;
            $('.kucity_item dd').on('click',"div", function(e) {
                self.target.val(($(this).find(".region").text()));
                self.container.hide();
            })
        },
        //上下键选择搜索结果
    ...
    $.fn.kuCity = function(options) {
        ...
        target.on('focus', function(e) {
            ...
            kucity.resultct.on('click', 'li', function() {
                kucity.target.val($(this).find('.region').text());
